	...
	<div id="department " style="background-image: url('<?php echo get_template_directory_uri().'/asset/image/background.jpg'; ?>');background-size: cover !important;background-repeat: no-repeat !important;background-attachment: fixed;">
		<div class="container">
			<div id="banner-holder" class="transparent-banner">
				<h2 id="dept-title">EVENT DETAILS</h2>
							...
							<div class="panel panel-default ">
								...
								<div class="panel-body ">
									...
									<div class="row">
										...
										<div style="padding-left: 10px;"><i style="color: red;" class="fa fa-calendar" aria-hidden="true"></i><?php echo ' '.$Event_newDate.'   '; ?>
											<?php
										...
										<div style="overflow-x:auto;">
											<table class="table table-hover table-striped table-responsive">
												...
												<tr>
													<td>	<p class="btn btn-primary" style="text-align: center;"><i class="fa fa-arrow-left"></i><a href="<?php echo get_bloginfo('url').'/event' ?>">Back<span></span></a></p>
													</td>
