...
<div id="department " style="background-image: url('<?php echo get_template_directory_uri().'/asset/image/background.jpg'; ?>');background-size: cover !important;background-repeat: no-repeat !important;background-attachment: fixed;">
	<div class="container">
		<div id="banner-holder" class="transparent-banner">
			<h2 id="dept-title">Department Teachers</h2>
					...
					<div class="col-md-12 ">
						<div class="panel panel-default ">
							<div class="panel-heading">
								<p style="color: #575fcf;">Teachers | Department of <?php echo get_bloginfo('description') ?></p>
							</div>
							...
							<div class="panel-body ">
								<div class="row">
									...
									while(have_posts()) {
										...
										$faculty_meta_is_chairman = get_post_meta($faculty_id, '_pustdep_chai', true);
										if('on' == $faculty_meta_is_chairman) {
											$faculty_meta_designation   = 'Chairman';
                                            ...
                                            <div class="col-md-4 to_profile">
                                                <div class="details">
                                                    <div class="book" style="height:250px !important;">
                                                        ...
                                                        <div class="page6">
                                                            <ul class="social">
                                                                <p style="margin: 0px !important;color: #f53b57;"><b>Contact
                                                                        Details</b></p>
																<?php
																if ( '' != $faculty_meta_mob1 ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                class="fa fa-phone"
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_mob1; ?>
                                                                    </p>
																	<?php
																}
																?>
																...
																if ( '' != $faculty_meta_mob2 ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                class="fa fa-phone"
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_mob2; ?>
                                                                    </p>
																	<?php
																}
																?>
																...
																if ( '' != $faculty_meta_pabx ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                class="fa fa-phone"
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_pabx; ?>
                                                                    </p>
																	<?php
																}
																?>
																...
																if ( '' != $faculty_meta_ipt ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                class="fa fa-phone"
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_ipt; ?>
                                                                    </p>
																	<?php
																}
																?>
																...
																if ( '' != $faculty_meta_e1 ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                ...
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_e1; ?>
                                                                    </p>
																	<?php
																}
																?>
																...
																if ( '' != $faculty_meta_e2 ) {
                                                                    ...
                                                                    <p style="margin: 0px !important;"><i
                                                                                class="fa fa-envelope"
                                                                                aria-hidden="true"></i> <?php echo $faculty_meta_e2; ?>
                                                                    </p>
																	<?php
																}
																?>
                                                        ...
                                                        <div class="page5" style="line-height: normal;">
                                                            ...
                                                            <p style="font-size:12px;margin:0px;line-height:normal;"><b>Research
                                                                    Area:</b></p>
								...
								<h2 style="margin:10px;border-bottom: 1px dashed #596275;"><i class="fa fa-hand-o-right" aria-hidden="true"></i>Faculty Members</h2>
                                ...
                                while(have_posts()) {
                                    ...
                                    <div class="col-md-4 to_profile">
                                        <div class="details">
                                            ...
                                            <h4 style="color: #000;" class="">
                                                <a href="<?php echo esc_url( get_permalink() ); ?>"><?php the_title(); ?><br>
                                                    <span><?php echo $faculty_meta_designation; ?></a></span>
                                            </h4>
                                            <a href="<?php echo esc_url(get_permalink()); ?>" class="btn btn-info">View Profile</a>
                                        </div>
